...
# root should own config
#sudo chown root:root ${DOTFILES}/install/dnscrypt-proxy.toml
# Use hard link; not sim link. ProtectHome in systemd config prevents service from reading linked file.
#sudo ln -fn ${DOTFILES}/install/dnscrypt-proxy.toml /etc/dnscrypt-proxy/
#
## mouse/keyboard
